-- Fix quote-share cryptographic function resolution.
--
-- Migration 032 intentionally hardens these RPCs with:
--   search_path = pg_catalog, public
-- Supabase installs pgcrypto functions in the extensions schema, so the
-- cryptographic calls must be schema-qualified rather than widening search_path.
--
-- No lifecycle, token format, privilege, signature, or business-rule change.
