    ...
    <div className="flex flex-wrap items-center gap-2">
      {!closed && (
        <form action={cancelAction}>
          ...
          <button className="rounded-xl border border-amber-300/15 bg-amber-300/[0.04] px-3 py-2 text-[11px] font-medium text-amber-100/70 transition hover:border-amber-300/30 hover:text-amber-100">
            Annuler la demande
          </button>
        </form>
      )}
