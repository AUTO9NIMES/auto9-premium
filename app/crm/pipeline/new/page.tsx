  ...
  return (
    <div data-crm-route="pipeline" className="space-y-10">
      ...
      <nav aria-label="Mode de saisie" className="flex gap-6 border-b border-white/10">
        <Link href="/crm/pipeline/new" aria-current={mode === "existing" ? "page" : undefined} className={`border-b-2 pb-3 text-xs uppercase tracking-[0.14em] ${mode === "existing" ? "border-[#d8b477] text-[#d8b477]" : "border-transparent text-white/45 hover:text-white"}`}>Client existant</Link>
        <Link href="/crm/pipeline/new?mode=new" aria-current={mode === "new" ? "page" : undefined} className={`border-b-2 pb-3 text-xs uppercase tracking-[0.14em] ${mode === "new" ? "border-[#d8b477] text-[#d8b477]" : "border-transparent text-white/45 hover:text-white"}`}>Nouveau client</Link>
      </nav>
      ...
      {mode === "new" && <form action={createManualLeadAction} className="space-y-8 border border-white/10 bg-[#101419] p-5 md:p-7">
        ...
        <section aria-labelledby="new-customer-form" className="grid gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2"><label htmlFor="fullName" className="block text-xs text-white/55">Nom complet</label><input id="fullName" name="fullName" required maxLength={200} className="mt-2 w-full border border-white/15 bg-[#0d1014] px-3 py-2.5 text-sm text-white outline-none focus:border-[#d8b477]" /></div>
          <div><label htmlFor="firstName" className="block text-xs text-white/55">Prénom <span className="text-white/30">(optionnel)</span></label><input id="firstName" name="firstName" maxLength={100} className="mt-2 w-full border border-white/15 bg-[#0d1014] px-3 py-2.5 text-sm text-white outline-none focus:border-[#d8b477]" /></div>
          <div><label htmlFor="lastName" className="block text-xs text-white/55">Nom <span className="text-white/30">(optionnel)</span></label><input id="lastName" name="lastName" maxLength={100} className="mt-2 w-full border border-white/15 bg-[#0d1014] px-3 py-2.5 text-sm text-white outline-none focus:border-[#d8b477]" /></div>
          ...
          <div><label htmlFor="city" className="block text-xs text-white/55">Ville <span className="text-white/30">(optionnel)</span></label><input id="city" name="city" maxLength={120} className="mt-2 w-full border border-white/15 bg-[#0d1014] px-3 py-2.5 text-sm text-white outline-none focus:border-[#d8b477]" /></div>
        </section>
