...
export default async function JobDetailPage({ params, searchParams }: {
  ...
  const appointmentUpdated = Array.isArray(feedback.updated) ? feedback.updated[0] : feedback.updated;
  ...
  return (
    <div data-crm-route="jobs" className="space-y-12">
      ...
      <section aria-labelledby="job-appointment" className="space-y-4">
        ...
        {appointmentUpdated === "1" && <p role="status" className="border border-emerald-300/30 bg-emerald-300/5 px-4 py-3 text-sm text-emerald-200">Rendez-vous mis à jour.</p>}
