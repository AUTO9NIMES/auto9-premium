...
export default async function JobsPage() {
  ...
  return (
    <div data-crm-route="jobs" className="space-y-10">
      ...
      <section aria-labelledby="jobs-list" className="border border-white/10 bg-[#101419]">
        <div className="flex items-center justify-between border-b border-white/10 px-5 py-4 md:px-7">
          <h2 id="jobs-list" className="text-sm font-medium text-white">Registre des prestations</h2>
          <span className="text-xs text-white/30">0 prestation</span>
        </div>
        <div className="flex min-h-56 items-center justify-center px-6 py-12 text-center">
          <div>
            ...
            <p className="mt-5 text-sm text-white/65">Les prestations apparaîtront ici.</p>
            <p className="mt-2 text-xs text-white/35">Prêt pour la couche de lecture CRM jobs.</p>
          </div>
        </div>
      </section>
    </div>
