  ...
  return (
    <div className="space-y-7">
      <header className="flex flex-col justify-between gap-5 xl:flex-row xl:items-end">
        ...
        <Link href="/crm/subscriptions?new=1" className="w-fit rounded-xl border border-cyan-300/30 bg-cyan-300/10 px-4 py-3 text-xs font-semibold text-cyan-100">
          + Nouvel abonnement
        </Link>
      </header>
      ...
      {showNew && (
        <section className="rounded-3xl border border-cyan-300/15 bg-gradient-to-br from-cyan-300/[0.06] to-blue-500/[0.025] p-5 md:p-6">
          <div className="flex items-start justify-between gap-4">
            ...
            <Link href="/crm/subscriptions" className="text-xs text-white/35 hover:text-white">Fermer ×</Link>
          </div>
            ...
            <article key={subscription.id} className={`rounded-3xl border p-5 md:p-6 ${due ? "border-amber-300/20 bg-amber-300/[0.035]" : "border-white/8 bg-[#0b121b]"}`}>
              <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div className="flex flex-wrap gap-2">
                  <Link href="/crm/calendar" className="rounded-xl border border-white/10 px-3 py-2.5 text-xs text-white/65 hover:border-cyan-300/25 hover:text-cyan-100">
                    Planifier RDV
                  </Link>
                  {emailReady ? (
